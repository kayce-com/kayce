// What does a decentralized verification process look like in practice, when applied to physical assets?
// How can we ensure that the digital token stays truthfully linked to the changing condition(s) of such an asset?
...
import SelfPermit from "./libraries/SelfPermit.sol";
...
contract StakingPool is Ownable, Clone, Multicall, SelfPermit {
